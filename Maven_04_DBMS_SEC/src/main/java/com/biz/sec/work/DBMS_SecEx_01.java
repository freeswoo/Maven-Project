...
public class DBMS_SecEx_01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * java에서 쉽게 사용할수 있는 암호화, 복호화 수행하는 클래스
		 ...
		 * 그런데 이 방법으로 단뱡향 암호화 기법은 사용이 불가능하다.
		...
		System.out.printf("username : %s, enc : %s\n",planUserName,encUserName);
		System.out.printf("password : %s, enc : %s\n",planPassword,encPassword);
		
		/*
		 * username  ZEDi4ndzqeCKqAO8Zrmgbw==
		 * password  K1kQYwHL6uy8xyCPZzaQkg==
		 */
